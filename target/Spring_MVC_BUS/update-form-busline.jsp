    ...
    <nav class="navbar navbar-expand-lg navbar-light " style="background-color: burlywood">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link"href="./buslines" >Thêm Tuyến Đường</a>
                </li>
...
<form:form id="form" cssStyle="margin-top: 45px;" action="./${command.id}" method="POST">
    <root>
        <div class="form-group">
            <form:label cssStyle="margin-left: -16px;" path="buslineName">Tên Tuyến Đường</form:label>
            <form:input path="buslineName" value="${command.buslineName}"/>
            <br/>
        </div>
        <div class="form-group">
            <form:label cssStyle="padding-left: 13px;" path="distance">Khoảng Cách</form:label>
            <form:input path="distance" value="${command.distance}"/>
            <a>km</a>
            <br/>
        </div>
        <div class="form-group">
            <form:label cssStyle="margin-left: -11px;" path="stopNumber">Số Điểm Dừng</form:label>
            <form:input path="stopNumber" value="${command.stopNumber}"/>
            <br/>
        </div>
        <div class="form-group">
